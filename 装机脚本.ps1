...
Write-Host ""
$OfficeProcess=Start-Process -FilePath "D:\laptop_setup\Office2016\setup.exe" -Wait -PassThru
...
Write-Host "开始安装腾讯会议"
Write-Host ""
$TMProcess=Start-Process -FilePath "D:\laptop_setup\TencentMeeting.exe"  -ArgumentList '/SilentInstall=0 /Language="zh-cn"' -Wait -PassThru
...
Write-Host ""
$TMOutlook=Start-Process -FilePath "D:\laptop_setup\WeMeetOutlookPlugin.exe" -ArgumentList "/S" -Wait -PassThru
...
Write-Host ""
$PDFReader=Start-Process -FilePath "D:\laptop_setup\AcroRdrDC.exe" -ArgumentList "/sAll /rs /msi EULA_ACCEPT=YES" -Wait -PassThru
...
Write-Host "开始安装7zip"
Write-Host ""
$7zip=Start-Process -FilePath "D:\laptop_setup\7z2601-x64.exe" -ArgumentList "/S" -Wait -PassThru
...
Write-Host ""
$msipath="D:\laptop_setup\googlechromestandaloneenterprise64.msi"
...
Write-Host "开始安装企业微信"
Write-Host ""
$WxWork=Start-Process -FilePath "D:\laptop_setup\WeCom.exe" -ArgumentList "/S" -Wait -PassThru
...
$VPNpath="D:\laptop_setup\MotionPro_Windows.msi"
...
Write-Host ""
Write-Host "开始安装加密软件"
$encrypt=Start-Process -FilePath "D:\laptop_setup\亿赛通加密软件\V3.8S_Client\setup.exe" -ArgumentList '/s /L0x0804 /f1"D:\laptop_setup\亿赛通加密软件\V3.8S_Client\CDG_setup.iss"' -WorkingDirectory "D:\laptop_setup\亿赛通加密软件\V3.8S_Client" -Wait -PassThru
...
#Install Mcafee ENS
Write-Host "开始安装ENS"
$ENS=Start-Process -FilePath "D:\laptop_setup\Mcafee\ENS\setupEP.exe" -ArgumentList 'ADDLOCAL="tp" /quiet' -Wait -PassThru
if($ENS.ExitCode -eq 0){Write-Host "ENS 安装成功"}
else{Write-Host "ENS 安装失败"}
Write-Host ""
#Install FRP
Write-Host "开始安装FRP"
$FRPDIR="D:\laptop_setup\Mcafee\FRP\MfeFRP_Client_5.5.0.267\eeff64.msi" 
...
$DLP=Start-Process -FilePath "D:\laptop_setup\Mcafee\DLP\DLPAgentInstaller.x64.exe" -ArgumentList "/exenoui /quiet" -Wait -PassThru
...
Write-Host "开始安装联软"
Write-Host ""
$Lianruan=Start-Process -FilePath "D:\laptop_setup\联软桌面助手.exe" -ArgumentList "/quiet /NoQueryBox" 
Start-Sleep 120
